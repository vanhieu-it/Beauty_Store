	...
	<ul class="navbar-nav ms-auto">
		...
		<li class="nav-item dropdown d-none d-lg-block user-dropdown"><a
			...
			aria-expanded="false"> <img class="img-xs rounded-circle"
				src="${userLogin.getAvatar() }" style="border: 2px solid red" alt="Profile image">
		</a>
			<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
				aria-labelledby="UserDropdown">
				<div class="dropdown-header text-center">
					<img class="img-md rounded-circle"
						src="${userLogin.getAvatar() }" style="width: 60px;height: 60px;border: 2px solid red" alt="Profile image">
