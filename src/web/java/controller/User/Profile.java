...
public class Profile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("password").equals("password") == true) {
			new UserDAO().editUserNotPass(request.getParameter("id"), request.getParameter("email"),
					request.getParameter("fullname"), request.getParameter("phone"), request.getParameter("avatar"));
		} else {
